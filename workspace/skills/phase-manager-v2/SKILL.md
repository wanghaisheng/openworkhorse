...
execution_framework_integration:
  wbs_structure_loading:
    method: "execution_framework.loadWBS()"
    auto_parsing: true
    milestone_tracking: true
    
  granularity_control:
    method: "execution_framework.granularityControl.ValidateTaskSize()"
    min_lines: 300
    max_lines: 800
    target_files: 6
    max_files: 12
  ...
  milestone_status_update:
    method: "execution_framework.WBSUpdate"
...
input:
  ...
  use_wbs_framework: boolean     # 使用ExecutionFramework的WBS功能
  granularity_enforcement: boolean # 启用粒度控制
```
